...
| 2026-04-02 | Asset Library marquee — all silo images replaced with lifestyle images | All 14 unique asset cards in the `.showcase` section (both marquee rows) now use `02 Lifestyle/` images only. Silo images in other sections (hero editor, mission, pipeline) are unchanged. Applied to `outputs/homepage-v10.html` and `index.html`. |
